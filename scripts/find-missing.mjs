...
fs.writeFileSync('scripts/generate_imagen_pipeline.py', lines.join('\n'), 'utf8');
console.log('✅ scripts/generate_imagen_pipeline.py updated with Prompt Booster & Dual Storage!');
